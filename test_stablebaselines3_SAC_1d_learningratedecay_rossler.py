...
x = f_t(dyn_rossler, Rossler, 0.01, x0_rossler, 10000)
...
model.save("sac_rossler_5_0.5rad_100alpha_rreward_fixed")


del model # remove to demonstrate saving and loading
new_x = []
model = SAC.load("sac_rossler_5_0.5rad_100alpha_rreward_fixed")
env.reset()
obs = x[:,-1]
new_x.append(obs)
for i in range(5000):
...
ax.plot(np.array(list(range(len(xfinal[0]))))+10000, xfinal[0])
ax.axhline(y = 0.0070262, color = 'r', linestyle = 'dashdot')
